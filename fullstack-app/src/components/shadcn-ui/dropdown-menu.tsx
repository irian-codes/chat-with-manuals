...
>(({className, ...props}, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'bg-popover text-popover-foreground motion-duration-200 data-[side=bottom]:motion-preset-slide-down data-[side=left]:motion-preset-slide-left data-[side=right]:motion-preset-slide-right data-[side=top]:motion-preset-slide-up z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-lg',
      className
    )}
    {...props}
  />
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        'motion-duration-200 data-[side=bottom]:motion-preset-slide-down data-[side=left]:motion-preset-slide-left data-[side=right]:motion-preset-slide-right data-[side=top]:motion-preset-slide-up',
        className
      )}
      {...props}
    />
